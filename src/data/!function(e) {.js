...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        c = n.end.column,
        e += " - " + i + ":" + s);
        for (var l = Error.prototype.constructor.call(this, e), u = 0; u < r.length; u++)
            this[r[u]] = l[r[u]];
...
, function(e, t, n) {
    ...
    t.sendHost = t.sendInterface = t.sendByScript = t.loadResource = t.getHq = t.sendJsonp = t.ajax = t.send = void 0;
    var r = n(24)
      , o = n(6)
      , i = n(15)
      , a = n(8);
    ...
    function s(e, t, n, r) {
        ...
        new Promise(function(n, r) {
            var o = new XMLHttpRequest
              , i = [];
            for (var a in t)
                i.push(a + "=" + encodeURIComponent(t[a]));
            var s = i.join("&");
            o.responseType = "json",
    ...
    t.send = function(e, t, n) {
        ...
        var o = "";
        "string" == typeof t ? o = t : (t = Object.assign({}, t),
        o = r.params(t));
        var a = {
            param: o,
            plat: "Web",
        ...
        return i.env.isDevelop ? (n = "//guba-test.eastmoney.com/interface/GetData.aspx",
        a.origin = window.location.origin) : (i.env.isTest,
    ...
    t.ajax = s,
    t.sendJsonp = c,
    t.getHq = function(e, t) {
        var n = (void 0 === t ? {
            fields: ""
        } : t).fields
          , r = a.getHQSecIdByMutiCode(e)
          , o = r.indexOf(",") >= 0
          , i = "";
        return n || (n = o ? "f1,f2,f3,f4,f12,f13,f14,f152,f15,f16" : "f43,f170,f57,f107,f58"),
        i = o ? "https://push2.eastmoney.com/api/qt/ulist.np/get?fltt=2&np=3&ut=a79f54e3d4c8d44e494efb8f748db291&invt=2&secids=" + r + "&fields=" + n : "https://push2.eastmoney.com/api/qt/stock/get?fltt=2&ut=a79f54e3d4c8d44e494efb8f748db291&invt=2&secid=" + r + "&fields=" + n,
    ...
    t.loadResource = function(e, t, n) {
        ...
        "js" == i ? ((a = document.createElement("script")).setAttribute("type", "text/javascript"),
        ...
        ) : "css" == i && ((a = document.createElement("link")).setAttribute("rel", "stylesheet"),
    ...
    t.sendInterface = function(e, t) {
        var n = "/" + e;
        return t = t || {},
        i.env.isDevelop && (n = "//guba-test.eastmoney.com" + n,
        t.origin = window.location.origin),
        s(n, t)
    }
    ,
    t.sendHost = function() {
        var e = "//gbcdn.dfcfw.com/rank/"
          , t = "//guba.eastmoney.com/rank/";
        return i.env.isRelease || (e = "//gbcdn-test.dfcfw.com/rank/",
        t = "//guba-test.eastmoney.com/rank/",
        location.hostname.indexOf("guba-testd") >= 0 && (e = "//gubacdnimgtest.dfcfw.com/rank/",
        t = "//guba-testd.eastmoney.com/rank/")),
        {
            gbcdnHost: e,
            gbHost: t
        }
...
, function(e, t, n) {
        ...
        if (e) {
            ...
            return e = e.replace(n, function(e) {
                for (var n = 0; n < t.length; n++)
                    if ("[" + t[n] + "]" == e)
                        return '<img class="emot" title="' + t[n] + '" src="http://gbfek.dfcfw.com/face/emot_default/emot' + (n + 1) + '.png" alt="' + e + '">';
                return e
            })
        }
        return ""
    ...
    function o(e) {
        return setTimeout(function() {
            ...
            e.scrollHeight - 10 > n ? function n() {
                ...
                e.innerHTML = t + "...",
                e.scrollHeight - 10 > e.clientHeight ? n() : e.innerHTML = t + "..."
            }() : e.innerHTML = t
        }, 0),
        !1
    }
    ...
    t.fixedQuote = t.formatQuoteZDF = t.cutCommentTexts = t.cutTexts = t.cutText = t.showface = t.CtoH = t.getQueryString = void 0,
    ...
    t.CtoH = function(e) {
        for (var t = "", n = 0; n < e.length; n++)
            12288 != e.charCodeAt(n) ? e.charCodeAt(n) > 65280 && e.charCodeAt(n) < 65375 ? t += String.fromCharCode(e.charCodeAt(n) - 65248) : t += String.fromCharCode(e.charCodeAt(n)) : t += String.fromCharCode(e.charCodeAt(n) - 12256);
        return t
    }
    ,
    t.showface = r,
    t.cutText = o,
    t.cutTexts = function(e) {
        return setTimeout(function() {
    ...
    t.cutCommentTexts = function(e) {
        ...
        setTimeout(function() {
            document.querySelectorAll(e).forEach(function(e) {
                var t, n;
                e.innerHTML = r((t = e.innerHTML,
                (n = /\[at=(.*?)\](.*?)\[\/at\]/gim).test(t) ? t.replace(n, '<a class="at_user" href="http://mguba.eastmoney.com/mguba/user/$1">$2</a>') : t))
            })
        }, 100),
        !1
    }
...
, function(e, t, n) {
    ...
    t.loadScript = t.jsonpGet = void 0;
    ...
    function i(e, t, n, r) {
        ...
        new Promise(function(i, a) {
            ...
            s += n + "=" + l) : s = e + "&" + n + "=" + l,
            window[l] = function(e) {
                window["jsonpData_" + l] = e,
                delete window[l]
            }
            ;
            var d = document.createElement("script");
            d.type = "text/javascript",
            d.src = r ? encodeURI(s) : s,
            d.id = l,
            d.onload = function(e) {
                u(e.target),
                i(window["jsonpData_" + l]),
                delete window["jsonpData_" + l]
            }
            ,
    ...
    t.loadScript = function e(t, n, o) {
        ...
        var i = encodeURI(t);
        if (a.get(i) != r.LOADED)
            if (o && "undefined" == typeof window.jQuery)
                e("//gbfek.dfcfw.com/libs/jquery/1.8.3/jquery.min.js", function() {
                    e(t, n)
                });
            else {
                a.set(t, r.LOADING);
...
, function(e, t, n) {
    ...
    t.deleteCookie = t.getCookie = t.getsec = t.setCookie = void 0;
    var r = n(5);
    function o(e) {
        var t = Number(e.substring(1, e.length))
          , n = e.substring(0, 1);
...
, function(e, t, n) {
    ...
    t.getSuffixByCode = t.getSuffixByMarket = t.getStockType = t.putMarketBeforeCode = t.getHSAB = t.getHQSecIdByCode = t.getHQSecIdByMutiCode = t.getMarketTypeByCode = void 0,
    t.getMarketTypeByCode = function(e) {
        if (0 == e.toLowerCase().indexOf("hk"))
            return "5";
        if (0 == e.toLowerCase().indexOf("us"))
            return "7";
        if (0 == e.toLowerCase().indexOf("sh"))
            return "1";
        if (0 == e.toLowerCase().indexOf("sz"))
            return "2";
        var t = "1"
          , n = e.substring(0, 1)
          , r = e.substring(0, 3);
        return "5" == n || "6" == n || "9" == n || "009" == r || "126" == r || "110" == r || (t = "2"),
        t
    }
    ,
    ...
    ,
    t.getHQSecIdByCode = r,
    t.getHSAB = function(e, t) {
        if (1 == e) {
            if (2 == t || 23 == t)
                return "沪A";
            if (3 == t)
    ...
    t.getSuffixByCode = function(e, t) {
        if (0 == e.toLowerCase().indexOf("hk") || 116 == t)
            return "hk";
        if (0 == e.toLowerCase().indexOf("us") || 105 == t || 106 == t || 107 == t)
            return "us";
        if (0 == e.toLowerCase().indexOf("sh"))
            return "sh";
        if (0 == e.toLowerCase().indexOf("sz"))
        ...
        var n = "sh"
          , r = e.substring(0, 1)
          , o = e.substring(0, 3);
        return "5" == r || "6" == r || "9" == r || "009" == o || "126" == o || "110" == o || (n = "sz"),
        n
    }
}
, function(e, t, n) {
    ...
    u.prototype = {
        ...
        registerPartial: function(e, t) {
            if ("[object Object]" === o.toString.call(e))
                ...
                if (void 0 === t)
                    throw new i["default"]('Attempting to register a partial called "' + e + '" as undefined');
                this.partials[e] = t
            }
        },
...
, function(e, t) {
    var n = {
        ...
        set: function(e, t, n, r) {
            ...
            if (n) {
                var i = this.getsec(n);
                o.setTime(o.getTime() + 1 * i),
                document.cookie = e + "=" + encodeURIComponent(t) + ";domain=" + r + ";path=/;expires=" + o.toGMTString()
            } else
                document.cookie = e + "=" + encodeURIComponent(t) + ";domain=" + r + ";path=/"
        },
        getsec: function(e) {
        ...
        removeCookie: function(e, t) {
            return this.get(e) !== undefined && (this.set(e, "", "-1"),
            !this.get(e))
        }
    };
    e.exports = {
    ...
    var r = n(7)
      ...
      , i = function() {
        ...
        e.prototype.logOut = function() {
            ...
            var e = new Date;
            document.cookie = "dcusername=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuserinfo=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcusermingchen=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuserpass=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuserpubinfo=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuserpubs=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuserkeys=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_name=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_info=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_mingchen=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_pass=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_pubinfo=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_pubs=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "dcuser_keys=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "puser_pname=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "puser_pinfo=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "pi=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "ct=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "ut=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
            document.cookie = "uidal=;path=/;domain=eastmoney.com;expires=" + e.toGMTString(),
...
, function(e, t, n) {
    ...
    var r = !1
      , o = !1
      , i = !1;
    window.location.host.indexOf(":9") >= 0 || window.location.host.indexOf(":8") >= 0 || window.location.host.indexOf("guangguang") >= 0 ? o = !0 : window.location.host.indexOf("-test") >= 0 || window.location.host.indexOf("test") >= 0 ? i = !0 : r = !0,
    t.env = {
        isRelease: r,
        isDevelop: o,
        isTest: i
...
, , function(e, t, n) {
    (function(r) {
        ...
        function(e) {
            function n(e) {
                var t = []
                  , n = []
                  , r = []
                  , o = Object.is || function(e, t) {
                    return e === t ? 0 !== e || 1 / e == 1 / t : e != e && t != t
                }
                  , i = function(e) {
                    if (e != e || 0 === e)
                        for (var t = this.length; t-- && !o(this[t], e); )
                            ;
                    else
                        t = [].indexOf.call(this, e);
                    return t
                }
                  , s = function(e, o) {
                    var a = i.call(n, e);
                ...
                return Object.create(a, {
                    ...
                    forEach: {
                        value: function(e) {
                            ...
                            for (var n = this.iterator(), r = t(), o = t(); r !== undefined; )
                                e.apply(arguments[1], [r[1], r[0], this]),
                                r = o,
                                o = t()
                        }
                    },
        ...
        function(e) {
            "use strict";
            e.Set || (console.log("not have Set"),
            e.Set = function() {
                var e = {
                    "[object Array]": !0,
                    "[object Arguments]": !0,
                ...
                function c(t) {
                    var r, s, c = 0;
                    if (i(this, "baseType", "Set", !1, !1),
                    i(this, "_data", {}, !1, !0),
                    o ? Object.defineProperty(this, "size", {
                        enumerable: !0,
                        configurable: !1,
                        get: function() {
                            return c
                    ...
                    t !== undefined && null !== t)
                        if ("object" == typeof (r = t) && (s = n.call(r),
                        !0 === e[s] || "number" == typeof r.length && r.length >= 0 && (0 === r.length || "object" == typeof r[0] && r[0].nodeType > 0)))
                            for (var l = 0; l < t.length; l++)
                                this.add(t[l]);
                        else
                            (t instanceof Set || "Set" === t.baseType) && t.forEach(function(e) {
                                this.add(e)
                            }, this)
                }
                var l = 0
                  , u = "obj_"
                  , d = "__objectPolyFillID"
                  , f = {
                    string: !0,
                    boolean: !0,
                    number: !0,
                ...
                function p(e, t) {
                    var r, i = typeof e;
                    if (f[i])
                        return i.substr(0, 3) + "_" + e;
                    if (null === e)
                        return "nul_null";
                    if ("object" === i || "function" === i)
                        return e[d] ? e[d] : t ? (r = u + l++,
                        "[object Object]" === n.call(e) && o ? Object.defineProperty(e, d, {
                            enumerable: !1,
                            configurable: !1,
                            writable: !1,
                            value: r
                ...
                return c.prototype = {
                    add: function(e) {
                        var t = p(e, !0);
                        return r(this._data, t) || (this._data[t] = e,
                        s(this, this.size + 1)),
                        this
                    },
                    clear: function() {
                    ...
                    "delete": function(e) {
                        var t = p(e, !1);
                        return !(null === t || !r(this._data, t)) && (delete this._data[t],
                        s(this, this.size - 1),
                        !0)
                    },
                    remove: function(e) {
                    ...
                    forEach: function(e) {
                        if ("function" == typeof e)
                            for (var t, n, r = arguments[1], o = this.keys(); (t = o.next()) && !t.done; )
                                n = t.value,
                                e.call(r, n, n, this)
                    },
                    has: function(e) {
        ...
        function(t, r) {
            ...
            function p() {
                a ? u.removeEventListener(d, p, !1) : u.detachEvent("on" + d, p),
                l = !0
            }
            u.dataset === undefined && (o = /\-([a-z])/gi,
            i = /^data\-(.+)/,
            a = !!document.addEventListener,
            l = !1,
            a ? u.addEventListener(d, p, !1) : u.attachEvent("on" + d, p),
            u.setAttribute("foo", "bar"),
            Object.defineProperty(e.Element.prototype, "dataset", {
                get: l ? function() {
                    return this._datasetCache || (this._datasetCache = f.call(this)),
                    this._datasetCache
                }
                : f
            }),
        ...
        "document"in window.self && ("classList"in document.createElement("_") && (!document.createElementNS || "classList"in document.createElementNS("http://www.w3.org/2000/svg", "g")) || function(e) {
            ...
            if ("Element"in e) {
                var t = e.Element.prototype
                  ...
                  , s = function(e) {
                    for (var t = r.call(e.getAttribute("class") || ""), n = t ? t.split(/\s+/) : [], o = 0, i = n.length; o < i; o++)
                        this.push(n[o]);
                ...
                n.defineProperty) {
                    ...
                    try {
                        ...
                        e.number !== undefined && -2146823252 !== e.number || (u.enumerable = !1,
                        n.defineProperty(t, "classList", u))
                    }
                } else
      ...
      , s = function() {
        ...
        e.prototype.bind = function() {
            Array.prototype.forEach.call(this.queryAll(".user_info"), function(e) {
                ...
                e.addEventListener("mouseenter", function() {
                    var n, r;
                    null === (n = e.querySelector(".trg")) || void 0 === n || n.classList.remove("icon_down_s"),
                    null === (r = e.querySelector(".trg")) || void 0 === r || r.classList.add("icon_up_s"),
                    t.style.display = "block"
                }),
                e.addEventListener("mouseleave", function() {
                    var n, r;
                    null === (n = e.querySelector(".trg")) || void 0 === n || n.classList.remove("icon_up_s"),
                    null === (r = e.querySelector(".trg")) || void 0 === r || r.classList.add("icon_down_s"),
        ...
        e.prototype.popmsgInit = function() {
            ...
            var t = function() {
                e.popmsgGet(function(t) {
                    ...
                    r > 0 && r <= 99 ? (e.query(".user_info .my_msg i").innerHTML = r,
                    e.query(".user_info .my_msg i").classList.add("new_msg_tip")) : r > 99 && 0 == e.hasClass("my_msg", "icon_more_msg") && (e.query(".user_info .my_msg i").innerHTML = "",
                    e.query(".user_info .my_msg i").classList.remove("new_msg_tip"),
                    e.query(".user_info .my_msg i").classList.add("icon_more_msg"))
                })
            };
            setTimeout(function() {
                !function e() {
        ...
        e.prototype.makeMsg = function(e, t, n) {
            ...
            e += t) : t > 99 ? (0 == this.hasClass("topnavdownulmsgul", "icon_more_msg") && Array.prototype.forEach.call(this.queryAll(".topnavdownulmsgul em"), function(e, t) {
                t == n && (e.innerHTML = "",
                e.classList.remove("msg_num"),
                e.classList.add("icon_more_msg"))
            }),
...
, function(e, t, n) {
    ...
    t.isFromBaidualaddin = t.loadImg = t.photoZoom = t.share = t.addShareJS = t.setRemUnit = t.formatTime = t.throttle = t.params = void 0;
    var r = n(3);
    function o() {
        return new Promise(function(e, t) {
            setTimeout(function() {
                r.loadResource("//gbfek.dfcfw.com/libs/jquery/1.8.3/jquery.min.js", function() {
                    ...
                    r.loadResource("//gbfek.dfcfw.com/libs/share/share2.css", function() {}, !0)
                }, !0)
            }, 100)
        }
        )
    ...
    t.setRemUnit = function() {
        var e = document.documentElement
          , t = 100 * e.clientWidth / 375;
        e.style.fontSize = t + "px"
    }
    ,
    t.addShareJS = o,
    t.share = function(e, t, n, r, i) {
    ...
    t.photoZoom = function(e, t, n) {
        void 0 === t && (t = !0),
        void 0 === n && (n = ""),
        r.loadResource("//gbfek.dfcfw.com/project/gubawap/photoZoom/photoZoom.js", function() {
            window.photoZoom && new (0,
            window.photoZoom)(e,t,n).init()
        }, !0)
    }
    ,
...
, function(e, t, n) {
    ...
    (function(r) {
        t.__esModule = !0;
        var o, i = n(0), a = n(1), s = (o = a) && o.__esModule ? o : {
            "default": o
        };
        t["default"] = function(e) {
            e.registerHelper("each", function(e, t) {
                ...
                if (t.data && t.ids && (d = i.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
                i.isFunction(e) && (e = e.call(this)),
                t.data && (u = i.createFrame(t.data)),
                e && "object" == typeof e)
                    if (i.isArray(e))
                        for (var p = e.length; c < p; c++)
                            c in e && f(c, c, c === e.length - 1);
                    else if (r.Symbol && e[r.Symbol.iterator]) {
                        for (var h = [], m = e[r.Symbol.iterator](), g = m.next(); !g.done; g = m.next())
                            h.push(g.value);
                        for (p = (e = h).length; c < p; c++)
                            f(c, c, c === e.length - 1)
                    } else
                        n = undefined,
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var r, o = n(0), i = n(1), a = (r = i) && r.__esModule ? r : {
        "default": r
    };
    t["default"] = function(e) {
...
, function(e, t, n) {
    ...
    t["default"] = function(e) {
        e.registerHelper("log", function() {
            for (var t = [undefined], n = arguments[arguments.length - 1], r = 0; r < arguments.length - 1; r++)
                t.push(arguments[r]);
            var o = 1;
...
, function(e, t, n) {
    ...
    t["default"] = function(e) {
        e.registerHelper("with", function(e, t) {
            ...
            var r = t.data;
            return t.data && t.ids && ((r = o.createFrame(t.data)).contextPath = o.appendContextPath(t.data.contextPath, t.ids[0])),
            n(e, {
                data: r,
...
, function(e, t, n) {
    ...
    t.template = function(e, t) {
        ...
        var r = {
            ...
            invokePartial: function(n, r, i) {
                ...
                null == c && t.compile && (i.partials[i.name] = t.compile(n, e.compilerOptions, t),
                c = i.partials[i.name](r, s));
                if (null != c) {
                    if (i.indent) {
                        for (var l = c.split("\n"), u = 0, d = l.length; u < d && (l[u] || u + 1 !== d); u++)
                            l[u] = i.indent + l[u];
                        c = l.join("\n")
                    }
                    return c
            ...
            program: function(e, t, n, r, o) {
                var i = this.programs[e]
                  , a = this.fn(e);
                return t || o || r || n ? i = d(this, e, a, t, n, r, o) : i || (i = this.programs[e] = d(this, e, a)),
                i
            },
            data: function(e, t) {
                for (; e && t--; )
        ...
        function i(t) {
            var n = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1]
              , o = n.data;
            i._setup(n),
            !n.partial && e.useData && (o = function(e, t) {
                t && "root"in t || ((t = t ? s.createFrame(t) : {}).root = e);
                return t
            }(t, o));
            var a = undefined
              , c = e.useBlockParams ? [] : undefined;
            function l(t) {
                return "" + e.main(r, t, r.helpers, r.partials, o, c, a)
            }
            return e.useDepths && (a = n.depths ? t != n.depths[0] ? [t].concat(n.depths) : n.depths : [t]),
            (l = p(e.main, l, r, n.depths || [], o, c))(t, n)
        }
        return i.isTop = !0,
        i._setup = function(i) {
            if (i.partial)
                ...
                r.helpers = a,
                e.usePartial && (r.partials = r.mergeIfNeeded(i.partials, t.partials)),
                (e.usePartial || e.useDecorators) && (r.decorators = o.extend({}, t.decorators, i.decorators)),
                r.hooks = {},
                r.protoAccessControl = u.createProtoAccessControl(i);
                var s = i.allowCallsToHelperMissing || n;
                c.moveHelperToHooks(r, "helperMissing", s),
                c.moveHelperToHooks(r, "blockHelperMissing", s)
            }
        }
        ,
    ...
    var r, o = function(e) {
        ...
        return t["default"] = e,
        t
    }(n(0)), i = n(1), a = (r = i) && r.__esModule ? r : {
        "default": r
    }, s = n(9), c = n(10), l = n(40), u = n(12);
    function d(e, t, n, r, o, i, a) {
        ...
        return (s = p(n, s, e, a, r, i)).program = t,
    ...
    function p(e, t, n, r, i, a) {
        if (e.decorator) {
            var s = {};
            t = e.decorator(t, s, n, r && r[0], i, a, r),
            o.extend(t, s)
        }
        return t
    }
...
, function(e, t, n) {
    ...
    var r = n(6)
      ...
      , a = function() {
        ...
        return e.prototype.init = function() {
            this.query("#searchHeader").innerHTML = o(),
            this.bindSearch(),
            i.launchIn(".historybox")
        }
        ,
                ...
                var t, n = new suggest2017({
                    ...
                    onConfirmStock: function(t) {
                        ...
                        var r = t.stock.Code
                          ...
                          , i = t.stock.MktNum
                          , a = t.stock.JYS;
                        return 0 != i && 1 != i && (r = a + "_" + r),
                        e.query("#heat_search").value = r,
                        e.query("#heat_search").setAttribute("code", r),
                        e.query("#heat_search").setAttribute("name", o),
                        window.open("/rank/stock?code=" + r, "_blank"),
                        n.hide(),
                        !1
                    }
                });
                (t = window.jQuery)("#heat_search").change(function() {
                    var e = t(".suggest2017:visible").length > 0
                      , n = t(".suggest2017 .sg2017table tr").length > 0;
                    if (t(".suggest2017 .sg2017nof").length,
                    n && e) {
                        var r = t(".suggest2017 .sg2017table tr:first").data("stockdata");
                        t("#heat_search").val(r.Code),
                        t("#heat_search").attr("code", r.Code),
                        t("#heat_search").attr("name", r.Name)
                    } else
                        t("#heat_search").attr("code", 0),
                        t("#heat_search").attr("name", 0)
                }),
        ...
        launchIn: function(e) {
            !function(e) {
                ...
                if (n.stockItem.length < 1)
                    return !1;
                t.stockItem = n.stockItem.slice(0, 3),
                t.hasMoreHistory = n.stockItem.length > 3 ? "show" : "hide",
                "show" == t.hasMoreHistory && (t.moreStockItem = n.stockItem.slice(3, 6)),
                $(e).html(r(t))
            }(e)
        }
    }
...
, function(e, t, n) {
    ...
    e.exports = (r["default"] || r).template({
        1: function(e, t, n, r, o) {
            var i, a, s = null != t ? t : e.nullContext || {}, c = e.hooks.helperMissing, l = e.lookupProperty || function(e, t) {
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        var t = "/list";
        e && e.host && (t = e.host);
        for (var n = r.storage.getItem("stock_history") ? r.storage.getItem("stock_history").split("/") : [], o = {
            stockItem: []
        }, i = 0; i < n.length; i++)
            try {
                var a = {}
                  , s = JSON.parse(n[i].replace(/、/g, "/")).stockname + "吧"
                  , c = JSON.parse(n[i]).barcode;
                if (!c || !s)
                    continue;
                a.stockName = s,
                a.barCode = c,
...
, function(e, t, n) {
    ...
    var i = function(e) {
        function t(t) {
            var n = this;
            return console.log(t, "options"),
            (n = e.call(this) || this).title = t.title,
            n.content = t.content,
            n.addClass = t.addOwnClass,
            n.show(),
            n
        }
        return o(t, e),
...
, function(e, t, n) {
    ...
    var o = function() {
        ...
        e.prototype.remove = function() {
            ...
            this.root.querySelector(".popbody").classList.add("pophide"),
            setTimeout(function() {
                r.testIEVerison() ? (e.root.removeNode(!0),
                e.mask.removeNode(!0)) : (e.root.remove(),
                e.mask.remove())
            }, 100)
        }
        ,
...
, function(e, t, n) {
    ...
    t.getBroswer = t.testIEVerison = void 0,
    t.testIEVerison = function() {
        var e = navigator.userAgent.toLowerCase()
          , t = e.indexOf("msie") > -1
          , n = e.match(/rv:([\d.]+)\) like gecko/)
          , r = e.match(/msie ([\d.]+)/);
    ...
    t.getBroswer = function() {
        ...
        return (e = n.match(/edge\/([\d.]+)/)) ? t.edge = e[1] : (e = n.match(/rv:([\d.]+)\) like gecko/)) ? t.ie = e[1] : (e = n.match(/msie ([\d.]+)/)) ? t.ie = e[1] : (e = n.match(/firefox\/([\d.]+)/)) ? t.firefox = e[1] : (e = n.match(/chrome\/([\d.]+)/)) ? t.chrome = e[1] : (e = n.match(/opera.([\d.]+)/)) ? t.opera = e[1] : (e = n.match(/version\/([\d.]+).*safari/)) && (t.safari = e[1]),
        t.edge ? {
            broswer: "Edge",
            version: t.edge
        } : t.ie ? {
...
, function(module, exports, __webpack_require__) {
    ...
    var net_1 = __webpack_require__(3)
      , rankTableHbs = __webpack_require__(67)
      , popitemHbs = __webpack_require__(68)
      , topicHbs = __webpack_require__(69)
      , chartHistorySmall_1 = __webpack_require__(51)
      , pager_1 = __webpack_require__(70)
      , tip_1 = __webpack_require__(52)
      , net = __webpack_require__(3)
      , text_1 = __webpack_require__(5)
      , rankTable = function() {
        function rankTable() {
            this.query = function(e) {
                return document.querySelector(e)
        ...
        return rankTable.prototype.init = function() {
            ...
            this.queryAll(".market_li").forEach(function(e) {
            ...
            this.getData(),
            this.sendApprove = !1,
            this.query(".ranktit.hotrank").addEventListener("click", function(t) {
                e.p = 1,
                e.sort = 0,
                e.getData(),
                e.query(".ranktit.rankup").classList.remove("active"),
                e.query(".ranktit.hotrank").classList.add("active"),
                e.sendApprove = !1
            }),
            this.query(".ranktit.rankup").addEventListener("click", function() {
                ...
                e.sort = 1,
                e.getData(),
                e.query(".ranktit.hotrank").classList.remove("active"),
                e.query(".ranktit.rankup").classList.add("active"),
                e.sendApprove = !1
            }),
            this.queryAll(".market_li").forEach(function(t, n) {
                t.addEventListener("click", function() {
                    ...
                    e.marketType = n,
                    e.getData(),
                    e.queryAll(".market_li").forEach(function(e) {
                        e.classList.remove("on")
                    }),
                    t.classList.add("on"),
                    e.sendApprove = !1
        ...
        rankTable.prototype.fixData = function(e) {
            ...
            e.forEach(function(e, r) {
                if (0 == t.sort)
                    switch (e.rankNumber) {
                    case 1:
                        e.top_rank = "icon_rank1",
                        e.rankNumber = "";
                        break;
                    case 2:
                        e.top_rank = "icon_rank2",
                        e.rankNumber = "";
                        break;
                    case 3:
                        e.top_rank = "icon_rank3",
                        e.rankNumber = ""
                    }
                e.changeNumber > 0 ? e.changetr = "rankup" : e.changeNumber < 0 ? e.changetr = "rankdown" : e.changetr = "",
                0 == e.newFans && 0 == e.ironsFans ? e.showbar = "none" : (e.leftb_width = Math.round(e.newFans / 100 * 150),
                e.rightb_width = Math.round(e.ironsFans / 100 * 150),
                e.barsplit_left = Math.round(e.newFans / 100 * 150) - 3),
                e.gubaCode = e.code,
                e.showCode = e.code,
                1 == t.marketType && (e.gubaCode = "hk" + e.code.substring(e.code.indexOf("_") + 1, e.code.length),
                e.showCode = e.code.substring(e.code.indexOf("_") + 1, e.code.length)),
                2 == t.marketType && (e.gubaCode = "us" + e.code.substring(e.code.indexOf("_") + 1, e.code.length),
                e.gubaCode.indexOf("_") > -1 && (e.gubaCode = e.gubaCode.replace("_", ".")),
                e.showCode = e.code.substring(e.code.indexOf("_") + 1, e.code.length)),
                n.push(e.code),
                e.strHistory = JSON.stringify(e.history)
            });
            var r = !0
              , o = !0;
        ...
        rankTable.prototype.bind = function(e, t) {
            this.query(".tablebox").innerHTML = popitemHbs(e),
            window.scrollTo({
                top: 0,
                behavior: "smooth"
            });
            ...
            this.query(".updata_time").innerHTML = o.substring(0, o.length - 3),
            this.getTopic(t.join(","))
        }
        ,
            ...
            net.sendByScript(net.sendHost().gbcdnHost + "interface/GetData.js?needClick=1&codes=" + e + "&path=newtopic/api/Topic/GubaCodeHotTopicNewRead&cb=topicList", "", function(n) {
                ...
                if (r && r.length > 0 && r[0].re) {
                    ...
                    e.split(",").forEach(function(e) {
                        if (o[e].length > 0) {
                            var n = o[e][0];
                            t.query(".item_" + e + " .stock_name_" + e).insertAdjacentHTML("afterend", topicHbs(n)),
                            t.query(".item_" + e).classList.add("hastopic")
                        }
                    })
                }
            }, function(e) {
        ...
        rankTable.prototype.gethqData = function(e) {
            ...
            net_1.getHq(e.join(",")).then(function(e) {
                ...
                (null === (n = null === e || void 0 === e ? void 0 : e.data) || void 0 === n ? void 0 : n.diff) && e.data.diff.forEach(function(e) {
                    var n = "grey";
                    switch (e.f4 > 0 ? n = "red" : e.f4 < 0 && (n = "green"),
                    e.domCode = e.f12,
                    e.f13) {
                    case 105:
        ...
        rankTable.prototype.makePager = function(e) {
            ...
            this.query(".jump_launch").onclick = function(e) {
                var n = t.query(".jump_input").value.trim()
                  , r = n.match(/\D/g)
                  , o = Number(t.query(".sumpage").innerHTML)
                  , i = !1;
                n && !r && Number(n) <= Number(o) && Number(n) > 0 && (i = !0),
                i ? (t.p = n,
                t.getData(),
                t.sendApprove = !1) : new tip_1.TipPop({
                    title: "提示",
                    content: "请输入有效的页码"
                })
            }
            ...
            this.queryAll(".pager a").forEach(function(e) {
                e.onclick = function(e) {
                    var n = e.currentTarget.classList.contains("on")
                      , r = e.currentTarget.getAttribute("data-page");
                    t.p = r,
                    t.sendApprove && !n && (t.getData(),
                    t.sendApprove = !1)
                }
            })
        }
...
, function(e, t, n) {
    ...
    e.exports = (r["default"] || r).template({
        ...
        9: function(e, t, n, r, o, i, a) {
            var s, c, l = null != t ? t : e.nullContext || {}, u = e.hooks.helperMissing, d = "function", f = e.escapeExpression, p = e.lookupProperty || function(e, t) {
                return Object.prototype.hasOwnProperty.call(e, t) ? e[t] : undefined
            }
            ;
        ...
        10: function(e, t, n, r, o) {
            var i, a = null != t ? t : e.nullContext || {}, s = e.hooks.helperMissing, c = e.escapeExpression, l = e.lookupProperty || function(e, t) {
                return Object.prototype.hasOwnProperty.call(e, t) ? e[t] : undefined
            }
            ;
        ...
        14: function(e, t, n, r, o) {
            var i, a = null != t ? t : e.nullContext || {}, s = e.hooks.helperMissing, c = "function", l = e.escapeExpression, u = e.lookupProperty || function(e, t) {
                return Object.prototype.hasOwnProperty.call(e, t) ? e[t] : undefined
            }
            ;
...
, function(e, t, n) {
    ...
    e.exports = (r["default"] || r).template({
        ...
        compiler: [8, ">= 4.3.0"],
        main: function(e, t, n, r, o) {
            var i, a, s = null != t ? t : e.nullContext || {}, c = e.hooks.helperMissing, l = "function", u = e.escapeExpression, d = e.lookupProperty || function(e, t) {
                return Object.prototype.hasOwnProperty.call(e, t) ? e[t] : undefined
            }
            ;
    ...
    var r = function() {
        ...
        e.prototype.getPagerElems = function() {
            ...
            var o = Math.ceil(t / n)
              , i = [];
            if (i.push("<span>"),
            (1 != r || this.options.needIndex) && i.push('<a class="first_page" data-page="1">首页</a>'),
            r > 1 && i.push('<a data-page="' + (r - 1) + '">上一页</a>'),
            r > 6 && o - 5 > r)
                for (var a = r - 5; a <= r + 5; a++)
                    i.push('<a data-page="' + a + '" ' + (r == a ? 'class="on"' : "") + ">" + a + "</a>");
            else if (r <= 6)
                for (a = 1; a <= 11 && (i.push('<a data-page="' + a + '" ' + (r == a ? 'class="on"' : "") + ">" + a + "</a>"),
                a != o); a++)
                    ;
            else {
                var s = 1;
            ...
            o > r && i.push('<a data-page="' + (r + 1) + '">下一页</a>'),
            this.options.needLast && i.push('<a class="last_page" data-page="' + o + '">尾页</a>'),
            this.options.needSum && i.push(' 共<span class="sumpage">' + o + "</span>页</span>"),
            this.options.needJumpLink && i.push('<span class="jump_page"> <input class="jump_input"> </span><span class="jump_launch">跳转</span>');
            var c = i.join("")
